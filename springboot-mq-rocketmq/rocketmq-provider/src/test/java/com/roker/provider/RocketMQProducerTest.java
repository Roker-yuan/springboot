package com.roker.provider;


import com.roker.provider.dto.BatchDto;
import com.roker.provider.dto.OrderPaidEvent;
import com.roker.provider.dto.OrderStep;
...
//            rocketMQService.sendMessage("Consumer_Cluster", null, i + "", "集群同步消息" + i);
    ...
    public void sendMessageByTag() {
        ...
        rocketMQService.sendMessage("Consumer_Tag:tag1", "过滤同步消息tag1-1");
    }
