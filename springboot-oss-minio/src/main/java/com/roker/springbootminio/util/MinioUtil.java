package com.roker.springbootminio.util;

import com.roker.springbootminio.config.MinioConfig;
import com.roker.springbootminio.domain.ObjectItem;
import io.minio.*;
    ...
    public List<String> upload(MultipartFile[] multipartFile) {
        ...
        for (MultipartFile file : multipartFile) {
            ...
            if (split.length > 1) {
                ...
                fileName =sb.toString() +  split[split.length - 2] + "_" + System.currentTimeMillis() + "." + split[split.length - 1];
            } else {
